...
smd(
  ...
  async (m) => {
    try {
      ...
      await m.send("Alyasa is thinking 🤔");
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("ALYASA• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("ALYASA • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
